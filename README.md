...
TODO:
1. Creating custom monitor display modes/modelines on wayland (didn't work: kanshi, wlr-randr, hyprland monitor option, video= kernel option, read-edid, hyprland env variables)
